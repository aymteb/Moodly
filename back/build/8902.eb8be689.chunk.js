(self.webpackChunkmoodly=self.webpackChunkmoodly||[]).push([[8902],{29520:function(N){function Z(d,o,g,j){for(var C=-1,O=d==null?0:d.length;++C<O;){var x=d[C];o(j,x,g(x),d)}return j}N.exports=Z},98694:function(N,Z,d){var o=d(1107);function g(j,C,O,x){return o(j,function(B,A,L){C(x,B,O(B),L)}),x}N.exports=g},37177:function(N,Z,d){var o=d(29520),g=d(98694),j=d(90040),C=d(26126);function O(x,B){return function(A,L){var Q=C(A)?o:g,ee=B?B():{};return Q(A,x,j(L,2),ee)}}N.exports=O},39738:function(N,Z,d){var o=d(93367),g=1/0;function j(C){var O=C==null?0:C.length;return O?o(C,g):[]}N.exports=j},63799:function(N,Z,d){var o=d(71041),g=d(37177),j=Object.prototype,C=j.hasOwnProperty,O=g(function(x,B,A){C.call(x,A)?x[A].push(B):o(x,A,[B])});N.exports=O},68902:function(N,Z,d){"use strict";d.d(Z,{P:function(){return Tt},a:function(){return Dt},u:function(){return vt}});var o=d(74081),g=d(27279),j=d(48102),C=d(10701),O=d(32370),x=d(93415),B=d(61181),A=d(5938),L=d(6918),Q=d(15244),ee=d(35250),H=d(73411),D=d(22572),R=d(23298),k=d(74577),G=d(45322),w=d(24920),le=d(34642),de=d(69878),se=d(94098),X=d(61908),W=d(87006),J=d(10131),F=d(10124),r=d(70627),K=d(61020),Re=d(76873),be=d(8243),_=d(72450),ce=d(35318),Pe=d(10411),Te=d(57853),Ge=d(78582),T=d(98934),je=d(74919),ve=d(89486),Oe=d(82298),he=d(61815),ue=d(63799),Ce=d(51943),Os=d(39738),ne=d(3243),Es=d(87830),Y=d(43433),De=d(8175),Xe=d(40464);const[Ms,As]=(0,Re.k)("PermissionsDataManager"),pe=()=>As("usePermissionsDataManager"),Rs=_.ZP.div`
  position: relative;
...
`,Is=(e,s,n)=>e.map(({actionId:t,isDisplayed:i,applyToProperties:a,label:l})=>{if(!i)return{actionId:t,hasSomeActionsSelected:!1,isDisplayed:i};const c=[...n.split(".."),t],p=F(a)?[...c,"properties","enabled"]:c,u=p.join(".."),m=T(s,[...c,"conditions"],null),f=oe(m).some(y=>y);if(F(a)){const y=T(s,p,!1);return{actionId:t,checkboxName:u,hasAllActionsSelected:y,hasConditions:f,hasSomeActionsSelected:y,isDisplayed:i,isParentCheckbox:!1,label:l,pathToConditionsObject:c}}const b=T(s,p,null),{hasAllActionsSelected:$,hasSomeActionsSelected:E}=ie(b);return{actionId:t,checkboxName:u,hasAllActionsSelected:$,hasConditions:f,hasSomeActionsSelected:E,isDisplayed:i,isParentCheckbox:!0,label:l,pathToConditionsObject:c}}),We=(e,s)=>`
  ${Je} {
...
`,ns=({availableActions:e,isActive:s,isGrey:n,isFormDisabled:t,label:i,onClickToggle:a,pathToData:l})=>{const[c,p]=(0,g.useState)(!1),{formatMessage:u}=(0,K.Z)(),{modifiedData:m,onChangeParentCheckbox:f,onChangeSimpleCheckbox:b}=pe(),$=()=>{p(I=>!I)},E=()=>{p(!1)},y=T(m,l.split(".."),{}),h=(0,g.useMemo)(()=>Object.keys(y).reduce((I,U)=>(I[U]=je(y[U],"conditions"),I),{}),[y]),{hasAllActionsSelected:M,hasSomeActionsSelected:P}=ie(h),v=(0,g.useMemo)(()=>Is(e,m,l),[e,m,l]),V=v.some(({hasConditions:I})=>I);return(0,o.jsxs)(Bs,{isActive:s,children:[(0,o.jsxs)(Je,{isGrey:n,children:[(0,o.jsx)(Qe,{isCollapsable:!0,isFormDisabled:t,label:i,checkboxName:l,onChange:f,onClick:a,someChecked:P,value:M,isActive:s,children:(0,o.jsx)(ss,{paddingLeft:2,children:s?(0,o.jsx)(Te.Z,{}):(0,o.jsx)(Ge.Z,{})})}),(0,o.jsx)(C.k,{style:{flex:1},children:v.map(({actionId:I,hasConditions:U,hasAllActionsSelected:S,hasSomeActionsSelected:z,isDisplayed:me,isParentCheckbox:q,checkboxName:te,label:_e})=>me?q?(0,o.jsxs)(es,{justifyContent:"center",alignItems:"center",children:[U&&(0,o.jsx)(ts,{}),(0,o.jsx)(H.C,{disabled:t,name:te,"aria-label":u({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${_e} ${i}`}),onValueChange:re=>{f({target:{name:te,value:re}})},indeterminate:z,value:S})]},I):(0,o.jsxs)(es,{justifyContent:"center",alignItems:"center",children:[U&&(0,o.jsx)(ts,{}),(0,o.jsx)(H.C,{disabled:t,indeterminate:U,name:te,onValueChange:re=>{b({target:{name:te,value:re}})},value:S})]},I):(0,o.jsx)(Ie,{},I))}),c&&(0,o.jsx)(Se,{headerBreadCrumbs:[i,"Settings.permissions.conditions.conditions"],actions:v,isFormDisabled:t,onClosed:E,onToggle:$})]}),(0,o.jsx)(ks,{children:(0,o.jsx)(Ee,{onClick:$,hasConditions:V})})]})};ns.propTypes={availableActions:r.array.isRequired,isActive:r.bool.isRequired,isGrey:r.bool.isRequired,isFormDisabled:r.bool.isRequired,label:r.string.isRequired,onClickToggle:r.func.isRequired,pathToData:r.string.isRequired};const Ws=_.ZP.span`
